...
function startPage() {
  // Verificăm dacă este prima accesare
...
\`\`\``;
    ...
    localStorage.setItem("markdownCode", defaultMarkdown);
    localStorage.setItem("documentName", "Document Markdown");
    localStorage.setItem("documentExtension", "document.md");
  }

  // Atribuim valorile salvate în Local Storage
